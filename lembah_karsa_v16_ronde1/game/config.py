"""
config.py — Konstanta global Lembah Karsa v5.
Ekspansi dari v4: tile IDs baru untuk kuburan, 3 gua, dan danau.
"""
...
class C:
    ...
    # Naga (oriental Indonesia)
    naga_body = (180, 60, 40)
    naga_body_dk = (120, 30, 20)
    naga_body_lt = (220, 100, 80)
    naga_belly = (245, 215, 100)
    naga_scale = (255, 235, 130)
    naga_horn = (255, 240, 180)
    naga_eye = (80, 220, 80)
    naga_whiskers = (255, 255, 200)
    # Cave
    cave_stone = (60, 50, 65)
    ...
    # Karakter manusia tambahan
    nc_joko = (90, 130, 80)
    nc_cici = (255, 180, 200)
    nc_bowo = (140, 90, 50)
    nc_ningsih = (220, 220, 240)
    nc_guru = (60, 80, 140)
    nc_mbokjum = (180, 140, 60)
    nc_jaka = (50, 60, 80)
    # Hewan tambahan
    ...
    wewe_dark = (40, 40, 60)
    wewe_red = (220, 80, 100)
    # === BARU v5: Kuburan, gua spesifik, danau ===
    crypt_stone = (75, 70, 80)         # crypt indoor
    crypt_stone_dk = (40, 35, 45)
    crypt_floor = (60, 55, 65)
    crystal_purple = (160, 80, 220)    # gua kristal
    crystal_blue = (80, 180, 240)
    crystal_pink = (240, 130, 200)
    crystal_glow = (200, 230, 255)
    bat_dropping = (60, 50, 35)        # gua kelelawar
    bat_brown = (50, 40, 30)
    waterfall_white = (240, 250, 255)  # danau air terjun
    waterfall_blue = (130, 200, 240)
    dock_wood = (110, 75, 40)          # dermaga
    dock_wood_dk = (75, 50, 25)
    boat_wood = (140, 95, 55)          # perahu
    boat_wood_dk = (95, 65, 35)
    lily_green = (60, 140, 70)         # eceng gondok
    lily_purple = (170, 120, 220)
    # UI
    ui_bg = (20, 10, 35)
    ui_bg2 = (35, 20, 55)
...
# ─── TILE IDs ─────────────────────────────────────────
# Original v4 (G..STR): 30 IDs
# Baru v5: CRYPT_W, CRYPT_F, CRYS, BAT_D, WTF (waterfall), DCK (dock),
#          BOT (boat), LLY (water lily/eceng gondok)
(G, D, P, W, FL, WL, TR, H, MB, DR, FN, GT, BD, ST, TB, BS, MR, FP, CL, PP, CH,
 CT, SH, GR, LN, DT, CV_W, CV_F, PEN, STR,
 CRYPT_W, CRYPT_F, CRYS, BAT_D, WTF, DCK, BOT, LLY) = range(38)
...
TILE_NAMES = {
    ...
    # Baru v5
    CRYPT_W: 'crypt_wall', CRYPT_F: 'crypt_floor',
    CRYS: 'crystal', BAT_D: 'bat_dropping',
    WTF: 'waterfall', DCK: 'dock', BOT: 'boat', LLY: 'water_lily',
}

# Player bisa jalan di:
# - Lantai dasar (G, D, P, FL, GT, CV_F, STR, CRYPT_F)
# - Tile danau yang bisa dilewati: DCK (dermaga), LLY (eceng gondok bisa diinjak, mengambang)
WALKABLE = {G, D, P, FL, GT, CV_F, STR, CRYPT_F, DCK, LLY, BAT_D}
TILLABLE = {G, D}
# Crystal blocking (decor), waterfall blocking, boat blocking (interact dulu)
BLOCKING = {W, WL, TR, FN, BD, ST, TB, BS, MR, FP, CL, PP, CH, CT, SH, GR, LN, DT,
            CV_W, PEN, CRYPT_W, CRYS, WTF, BOT}
