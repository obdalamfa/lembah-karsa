...
SCHEDULES = {
    ...
    # Manusia baru
    'joko': [
        (4,  9, 11, 'lake', 'fishing'),         # subuh di dermaga
        (10, 8, 11, 'lake', 'fishing'),         # pagi di ujung dermaga
        (15, 22, 3, 'shop', 'shopping'),        # sore beli
        (18, 9, 11, 'lake', 'fishing'),         # malam memancing
        (22, 9, 11, 'lake', 'sleeping'),
    ],
    'cici': [
    ...
    'kuntilanak': [
        (0,  -1, -1, 'hidden', 'dormant'),
        (20, 18, 8, 'lake', 'haunting'),         # malam di pohon mati pinggir danau
        (4,  -1, -1, 'hidden', 'dormant'),
    ],
    'pocong': [
        (0,  -1, -1, 'hidden', 'dormant'),
        (21, 8, 6, 'cemetery_z2', 'jumping'),    # kuburan zona menengah
        (3,  -1, -1, 'hidden', 'dormant'),
    ],
    'genderuwo': [
        (0,  -1, -1, 'hidden', 'dormant'),
        (19, 8, 7, 'bat_cave', 'roaming'),       # gua kelelawar
    ...
    'banaspati': [
        (0,  -1, -1, 'hidden', 'dormant'),
        (20, 8, 7, 'crystal_cave', 'floating'),  # api di gua kristal (tengah cluster)
        (4,  -1, -1, 'hidden', 'dormant'),
    ],
    'leak_bali': [
        (0,  -1, -1, 'hidden', 'dormant'),
        (23, 7, 5, 'cemetery_z3', 'transforming'),  # zona terdalam kuburan
        (3,  -1, -1, 'hidden', 'dormant'),
    ],
    # Hewan tambahan
    ...
    'kelinci_putih':  [(0, 16, 17, 'outdoor', 'hopping')],   # liar di rumput
}
